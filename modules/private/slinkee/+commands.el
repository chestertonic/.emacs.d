;;; private/slinkee/+commands.el -*- lexical-binding: t; -*-
...
;;; Custom commands
;; Emacs utilities
(ex! "bc[omp]"      #'+slinkee:byte-compile)
...
(ex! "k[ill]all"   #'+slinkee:kill-all-buffers)
(ex! "k[ill]m"     #'+slinkee:kill-matching-buffers)
